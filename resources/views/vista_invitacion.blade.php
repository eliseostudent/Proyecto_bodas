...
<head>
    ...
    <style>
        ...
        #frontFlap1 {
            width: 0;
            height: 0;
            border-bottom: 155px solid #EAF2F8;
...
<body id="inicio" data-spy="scroll" data-target=".navbar" data-offset="50">
    ...
    <script>
        ...
        el.css("border-bottom", w2 + "px solid #A9CCE3");
        el.css("width", "0 px");
        var t = w2 * .685 | 0;
        el.css("top", "-" + t + "px");
        var back = $("#backFlap");
        ...
        ff1.css("border-bottom", (wi * 0.588 | 0) + "px solid #EAF2F8");
        var of1 = $("#OpenFlap");
        of1.css("border-left", (w * 1.02 | 0) + "px solid transparent");
        of1.css(
            "border-right", w + "px solid transparent");
        of1.css("border-top", (w * 0.65 | 0) + "px solid #A9CCE3");
