...
<body class="font-sans antialiased">
    <div class="page-wrapper">
        <!-- HEADER MOBILE-->
        <header
            class="header-mobile d-block d-lg-none"style="background:#f5f5f5; box-shadow: 0px 2px 5px 0px rgb(0 0 0 / 10%);z-index: 3;">
                        ...
                        <div class="header-wrap ">
                            ...
                            @if (Route::has('login'))
                                <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
                                    ...
                                    @else
                                        <a href="{{ route('login') }}" class="text-sm  text-dark underline">Iniciar
                                            sesion</a>

                                        @if (Route::has('register'))
                                            <a href="{{ route('register') }}"
                                                class="ml-4 text-sm text-dark underline">Registrarse</a>
                                        @endif
                                    @endauth
                                </div>
                            @endif
                ...
                <main class="text-center">
                    <div class="w-100">
                        ...
                        <div class="row">
                            <div class="col"></div>
                            <div class="col-md-8">
                                <img style="width: 100%" src="{{ asset('app-images/welcome_image.jpg') }}"
                                    alt="Proyecto bodas imagen de ejemplo de la aplicacion." />
                            </div>
                            <div class="col"></div>
                        </div>
                        <h3 style="font-size:20px">Que esperas para crear tu evento registrate y comienza a trabajar.
                        </h3>
                        <div class="row">
                            <div class="col"></div>
                            <div class="col-md-8">
                                <img style="width: 100%" src="{{ asset('app-images/welcome_image_2.jpg') }}"
                                    alt="Proyecto bodas imagen de ejemplo de la aplicacion." />
                            </div>
                            <div class="col"></div>
                        </div>
